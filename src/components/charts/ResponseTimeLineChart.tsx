...
export default function ResponseTimeLineChart() {
  const { responseTimeTimeSeries, selectedAlgorithms } = useSimulationStore();

  if (responseTimeTimeSeries.length === 0) {
  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      <LineChart data={responseTimeTimeSeries} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
